...
import Loader from "./Loader"; // Use the Loader we created earlier
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg font-medium shadow-lg hover:shadow-purple-500/20 transition-all"
              >
                Sign In
              </motion.button>
            </form>
            ...
            >
              <span className="font-semibold text-blue-100"> Need access?</span>
